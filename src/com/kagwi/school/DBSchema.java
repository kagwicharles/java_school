...
public class DBSchema {
	...
	private static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS students (\n" + 
			"    id serial PRIMARY KEY, fullname VARCHAR(100), nationality VARCHAR(100), phone VARCHAR(10), email VARCHAR(100));";
	...
	public static String insertStudent() {
		String query = "INSERT INTO students(id, fullname, nationality, phone, email)"
				+ " VALUES(DEFAULT, ?, ?, ?, ?);";
		return query;
	}
